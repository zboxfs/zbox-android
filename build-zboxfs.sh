...
cp zboxfs/target/x86_64-linux-android/release/libzboxfs.so zbox/src/main/jniLibs/x86_64
cp zboxfs/target/aarch64-linux-android/release/libzboxfs.so zbox/src/main/jniLibs/arm64-v8a
