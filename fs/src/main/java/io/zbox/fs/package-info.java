 ...
 *
 * <ul>
 *     <li><b>{@link io.zbox.fs.Repo}</b> provides file system manipulation methods, such as openFile,
 *     createDir and etc.</li>
 *     <li><b>{@link io.zbox.fs.File}</b> provides file I/O methods, such as read, write, seek and etc.
 *     </li>
 * </ul>
 *
 ...
 *
 * <p>After repository is opened by {@link io.zbox.fs.RepoOpener}, all of the other functions provided
